		...
		try
		{
			rs=pstmt.executeQuery();
		                 if(rs.next())
                                                   {
%>
<form method="post" action="UpdateRecord.jsp" name="Form1" onsubmit="return checkvalidation(this)" >
  <table border="0" cellpadding="0" cellspacing="0"  width="65%" align="center">
   <tr align="center">
      <td width="66%" height="1" colspan="2" > <h1>Update Record</h1></td></tr>
     <tr>
...
%>
    ...
    <tr>
    <td colspan="2" align="center"><a href="http://localhost:8080/UpdateRecord.htm" > Go Back <<<<<---------</a></td>
    </tr>
  </table>
</form>
</body>
